...
LABEL maintainer="Emmanuel Davids <emmanueldavids417@gmail.com>"

LABEL version="1.0"
LABEL description="PatinkFolio Project"
LABEL tag="patinkfolio_v1.0"
...
#Copy all the resources and file in patinkWeb to the app directory
COPY ./patinkWeb /app
